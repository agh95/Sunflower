...
{
	public SunflowerComponent(Sunflower flower, int min, int max, final int value)
	{
		super();
		
		//create model
		final SunflowerModel model = new SunflowerModel(flower);
		...
		final SliderControl slider = new SliderControl(model, min, max, value);
